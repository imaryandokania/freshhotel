                    ...
                    <div className="flex flex-wrap -m-4">
                        {roomstate.map(room => (
                            <div key={room.sys.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
                                <Link to={{ pathname: `/view/room/Rs.{room.sys.id}/Rs.{room.fields.slug}` }} className="block relative h-48 rounded overflow-hidden">
                                ...
                                <div className="mt-4">
                                    ...
                                    <Link to={{ pathname: `/view/room/Rs.{room.sys.id}/Rs.{room.fields.slug}` }}>
                                        <h2 className="text-white title-font text-lg font-medium">{(room.fields.name).toUpperCase()}</h2>
                                    </Link>
                                    <p className="mt-1">Rs.{room.fields.price}</p>
                                </div>
                            </div>
                        ))}
                    </div>
