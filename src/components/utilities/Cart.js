                    ...
                    <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                ...
                                <tbody>
                                    {cartstate.map(item => (
                                        <tr key={item.sys.id}>
                                            ...
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p className="text-gray-900 whitespace-no-wrap">Rs. {item.fields.price}</p>
                                            </td>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            ...
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span
                                                    ...
                                                    <p className="text-gray-900 whitespace-no-wrap">{item.fields.price} * {item.total} = Rs.{(item.fields.price) * (item.total)}</p>
                                                </span>
                                            </td>
                                            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <div class="flex items-center justify-between mt-8">
                                ...
                                <p className="text-2xl text-white">Total Price Rs.{totalpay()}</p>
